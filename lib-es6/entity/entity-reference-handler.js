...
export function generateTypeEntityFromReference(reference, type, id, generateByTypeAndId) {
...
export function isEntityReferenceExist(reference, type, id) {
...
function addInherits(reference, type, entity) {
    if (entity.extend) {
        ...
        entityExtends_1.forEach(function () {
            entity = __assign({}, entityExtends_1.reduce(function (acc, currExtends) {
